        ...
        >
          {stats.map((item, index) => (
            <motion.div 
              ...
              variants={fadeUp}
              custom={index}
              className="bg-white p-8 rounded-3xl border border-slate-100 shadow-premium flex flex-col justify-between items-center text-center space-y-4 md:hover:-translate-y-2 transition-smooth"
            >
