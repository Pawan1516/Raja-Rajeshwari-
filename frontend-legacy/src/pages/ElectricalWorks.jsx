...
const categoryDetails = {
  "Residential Electrical Wiring": {
    ...
    desc_te: "ప్రీమియం పైపులు మరియు డిస్ట్రిబ్యూషన్ボードలతో కూడిన నివాసాల కోసం సురక్షితమైన వైరింగ్ వ్యవస్థలు."
  },
...
export default function ElectricalWorks() {
  ...
  return (
    <div className="min-h-screen bg-slate-955 text-slate-100 font-sans selection:bg-amber-500 selection:text-slate-950">
        ...
        <div className="bg-slate-900/50 rounded-3xl p-8 border border-white/10 mt-20 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-slate-950/60 rounded-2xl p-5 border border-white/5 flex items-start gap-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-white mb-1">IS-Certified Wiring</h4>
                <p className="text-slate-400 text-xs leading-relaxed">Exclusive use of fire-retardant (FR) copper wires from Finolex, Polycab or Havells.</p>
              </div>
            </div>
            <div className="bg-slate-950/60 rounded-2xl p-5 border border-white/5 flex items-start gap-4">
              <Zap className="w-8 h-8 text-amber-500 shrink-0 mt-1" />
              <div>
                <h4 className="text-sm font-bold text-white mb-1">Advanced Switchgear</h4>
                <p className="text-slate-400 text-xs leading-relaxed">RCCB and MCB installation with precise load calculations to prevent shock and short circuits.</p>
              </div>
            </div>
            <div className="bg-slate-950/60 rounded-2xl p-5 border border-white/5 flex items-start gap-4">
              <Wrench className="w-8 h-8 text-amber-500 shrink-0 mt-1" />
              <div>
                <h4 className="text-sm font-bold text-white mb-1">Systematic Testing</h4>
                <p className="text-slate-400 text-xs leading-relaxed">Strict insulation testing, earth-leakage check, and load testing before handover.</p>
              </div>
            </div>
            <div className="bg-slate-950/60 rounded-2xl p-5 border border-white/5 flex items-start gap-4">
              <CheckCircle className="w-8 h-8 text-amber-500 shrink-0 mt-1" />
              <div>
                <h4 className="text-sm font-bold text-white mb-1">Heavy Conduits</h4>
                <p className="text-slate-400 text-xs leading-relaxed">Deep-concealed PVC channels to protect cables from moisture and mechanical strain.</p>
              </div>
            </div>
          </div>
        </div>
