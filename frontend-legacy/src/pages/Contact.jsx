...
import { TEL_LINK, WA_GENERAL_LINK, PHONE_DISPLAY, TEL_LINK_2, PHONE_DISPLAY_2 } from '../constants';
...
export default function Contact() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-10 pb-20 relative overflow-hidden bg-dots">
      {/* Ambient background light blobs */}
      <div className="absolute top-1/3 -left-48 w-96 h-96 bg-forest/5 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/3 -right-48 w-96 h-96 bg-wood/5 rounded-full blur-[100px] pointer-events-none" />
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50/50 text-slate-800 text-sm px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:bg-white focus:border-forest/50 focus:ring-4 focus:ring-forest/10 focus:shadow-md transition-smooth"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full bg-slate-50/50 text-slate-800 text-sm px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:bg-white focus:border-forest/50 focus:ring-4 focus:ring-forest/10 focus:shadow-md transition-smooth cursor-pointer"
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50/50 text-slate-800 text-sm px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:bg-white focus:border-forest/50 focus:ring-4 focus:ring-forest/10 focus:shadow-md transition-smooth resize-none"
                  ></textarea>
                </div>
                ...
                <div className="pt-2">
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full sm:w-auto flex items-center justify-center gap-2 bg-wood hover:bg-wood-dark disabled:opacity-75 text-white px-8 py-4 rounded-xl font-bold text-xs transition-smooth shadow-premium hover:scale-[1.02] active:scale-95"
                  >
