...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-slate-950 text-slate-300 relative overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-forest-dark via-forest to-forest-dark py-3 px-4 text-center shadow-md">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <img 
                  ...
                  className="w-14 h-14 rounded-full object-cover border border-amber-500/20 shadow-md"
                />
                <div className="flex flex-col">
                  <h3 className="font-outfit font-extrabold text-lg tracking-tight text-white leading-none">
                    RAJA RAJESHWARI
                  </h3>
                  <p className="font-sans font-semibold text-[10px] text-wood-light tracking-widest uppercase mt-1">
                    INTERIOR WORKS
                  </p>
                </div>
              </div>
              ...
              <div className="flex space-x-3 pt-1">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-10 h-10 rounded-full bg-whatsapp hover:bg-whatsappdark flex items-center justify-center text-white transition-smooth shadow-md md:hover:scale-105 active:scale-95"
                  title="WhatsApp"
                >
                ...
                <a
                  href={TEL_LINK}
                  className="w-10 h-10 rounded-full bg-forest hover:bg-forest-dark flex items-center justify-center text-white transition-smooth shadow-call-glow md:hover:scale-105 active:scale-95"
                  title="Call Now"
                >
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm">
                {[
                  ...
                  { name: '⚡ Electrical Works', path: '/electrical-works' },
                  { name: '💡 Lighting Solutions', path: '/lighting-solutions' },
                  { name: 'Modular Kitchen', path: '/designs?category=Modular Kitchen Interiors' },
                  { name: 'False Ceiling Design', path: '/designs?category=False Ceiling Designs' }
                ].map((item, index) => (
                  <li key={index}>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href={TEL_LINK_2} className="hover:text-white transition-smooth text-slate-400 block">
                      {PHONE_DISPLAY_2}
                    </a>
                    <span className="text-xs text-slate-500">WhatsApp: {PHONE_DISPLAY} / {PHONE_DISPLAY_2}</span>
                  </div>
                </li>
