    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-forest selection:text-white">
      ...
      <section className="relative overflow-hidden py-24 border-b border-slate-800 bg-slate-950">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src="/backgrounds/lighting_bg.jpg" 
            alt="Lighting Solutions Background" 
        ...
        <div className="bg-green-50 rounded-3xl p-8 border border-green-200 mt-20 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm flex items-start gap-4">
              <Sun className="w-8 h-8 text-forest shrink-0 mt-1" />
              <div>
                <h4 className="text-sm font-bold text-slate-800 mb-1">CRI 90+ High Fidelity</h4>
                <p className="text-slate-500 text-xs leading-relaxed">We select LED light fixtures with high color rendering indices for natural colors.</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm flex items-start gap-4">
              <Eye className="w-8 h-8 text-forest shrink-0 mt-1" />
              <div>
                <h4 className="text-sm font-bold text-slate-800 mb-1">Anti-Glare Diffusers</h4>
                <p className="text-slate-500 text-xs leading-relaxed">Anti-glare reflectors and diffusers to prevent eye strain and create soft shadows.</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm flex items-start gap-4">
              <Sparkles className="w-8 h-8 text-forest shrink-0 mt-1" />
              <div>
                <h4 className="text-sm font-bold text-slate-800 mb-1">Layered Lighting Layout</h4>
                <p className="text-slate-500 text-xs leading-relaxed">Strategic layout separating ambient, task, and accent lighting for perfect balance.</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl p-5 border border-green-100 shadow-sm flex items-start gap-4">
              <Award className="w-8 h-8 text-forest shrink-0 mt-1" />
              <div>
                <h4 className="text-sm font-bold text-slate-800 mb-1">Smart Automation Ready</h4>
                <p className="text-slate-500 text-xs leading-relaxed">Dimmable drivers and smart integrations compatible with Alexa, Google Home, and Mobile Apps.</p>
              </div>
            </div>
          </div>
        </div>
