          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {mainServices.map((cat) => (
              <button
                ...
                className="group bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-premium shadow-premium-hover flex flex-col h-full text-left transition-smooth hover:-translate-y-2 w-full"
              >
                {/* Card Banner Image */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredSubcategories.map((sub) => (
                  <Link
                    ...
                    className="group h-80 rounded-3xl overflow-hidden relative shadow-premium shadow-premium-hover block transition-smooth hover:-translate-y-1.5"
                  >
                    <img
