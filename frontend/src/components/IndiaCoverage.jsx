          ...
          >
            ...
            <motion.div variants={fadeUp} custom={4} className="flex flex-wrap gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-2 bg-whatsapp hover:bg-whatsappdark text-white px-6 py-3 rounded-full font-bold text-sm transition-smooth shadow-lg hover:scale-105"
              >
              ...
              <a
                href={TEL_LINK}
                className="flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white px-6 py-3 rounded-full font-bold text-sm transition-smooth hover:scale-105"
              >
